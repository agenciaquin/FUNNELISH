...
function actualizarHeaderEffi() {
  ...
  // Conteo separado: volvieron = en AMBAS sets; solo-anuladas = solo en anulados; solo-effi = solo en vigentes
...
/* WhatsApp para clientes Anulados en Effi — envía solo "Hola" */
