 ...
 *
 * GENÉRICO por cliente: cada embudo trae su propio pixel (pixel_meta / pixel_tiktok),
 * su producto y su slug. Aquí solo se arma el evento con los datos que llegan, así
 * funciona igual para CUALQUIER tienda que use la plataforma.
 */
export default function Pixeles({
  ...
  useEffect(() => {
    ...
    // content_id: TikTok/Meta lo EXIGEN. Se usa un id estable del producto (slug del embudo).
