...
export async function POST(req: NextRequest) {
  ...
  const tipoLinea = tipoDeLinea(phoneIdEntrante);
  entrarLinea({
    phoneId: phoneIdEntrante ?? process.env.WHATSAPP_PHONE_NUMBER_ID ?? '',
    tipo: tipoLinea,
  });
      ...
      if (confirmedPedido) {
        ...
        const sysConf =
          ...
          (confirmedPedido.abono_recibido
            ...
            : '') +
          `IMPORTANTE: en este chat también escriben asesores humanos. Los mensajes que no son del cliente son tuyos o de un compañero: dalos por válidos, no repitas lo que ya se dijo ni contradigas lo que un asesor acordó con el cliente.\n` +
          ...
          `Si el cliente pide la cuenta para abonar: dale la Llave 0030538367 (funciona con Nequi, Daviplata y cualquier banco) o la cuenta de ahorros Bancolombia 303-000037-98 (Klixmant SAS). Si prefiere Nequi, dale Nequi 3505717342 (Jonatan Hurtado). Pídele el comprobante por este chat.\n` +
